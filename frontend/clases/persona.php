...
class Persona{
    ...
    //Funcion para hacer el login
     ...
     public function getFavs($conex){
          $pu = new persistenciaPersona;
          return $pu->getFavs($this,$conex);
     }

     public function getCompr($conex){
          $pu = new persistenciaPersona;
          return $pu->getCompr($this,$conex);
     }

     public function getVenta($conex){
          $pu = new persistenciaPersona;
          return $pu->getVenta($this,$conex);
     }

     public function getPregCompr($conex){
          $pu = new persistenciaPersona;
          return $pu->getPregCompr($this,$conex);
     }

     public function getPregVenta($conex){
          $pu = new persistenciaPersona;
          return $pu->getPregVenta($this,$conex);
     }
     //Funcion para hacer el registro
     public function registroUsu($conex){
          $pu = new persistenciaPersona;
          return $pu->registroUsu($this,$conex);
     }
   }
