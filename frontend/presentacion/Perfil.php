       ...
       <div class="container"  >
           <div class="row text-center">
             <table class="table">
                     ...
                     <?php
                       ...
                       if(!empty($num[0][0])){
                         ...
                         $b=intval($num[0]['preciototal']);
                          ...
                          echo "<input disabled type='text' id='contFact' name'contFact' class='form-control' value='Cantidad de productos vendidos: 0 '></input>";
                          echo "<input disabled type='text' id='contFact' name'contFact' class='form-control' value='Facturado: 0 '></input>";
                        }
                      ?>
                  </td>
               </tr>
                 ...
                 <td>
                     <?php
                         ...
                         if(!empty($num[0])){
                          ...
                          echo "<input disabled type='text' id='contFact' name'contFact' class='form-control' value='Promedio Reputación: 0'></input>";
                          echo "<input disabled type='text' id='contFact' name'contFact' class='form-control' value='Cantidad calificaciónes: 0'></input>";
                        }
                      ?>
                 </td>
               </tr>
               ...
               <tr>
                 <td></td>
                   <td><a href="pregCompras.php">Preguntas de compras</a></td>
               </tr>
               <tr>
                 <td></td>
               ...
               <tr>
                 <td>Ventas:</td>
                   <td><a href="pregVentas.php">Preguntas de ventas</a></td>
               </tr>
               <tr>
                 <td></td>
