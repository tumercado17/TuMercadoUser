...
<head>
    <?php
        ...
        require_once("../logica/procesarPregCompra.php");
        sessionCheck();
     ?>
    <meta charset="utf-8">
...
<body>
     ...
     <section  id="services-sec">
        <?php
        if(isset($_SESSION['pregCompr'])){
          if(!empty($_SESSION['pregCompr'])){
              $array = $_SESSION['pregCompr'];
              $val = count($array[0]);
                 ...
                 echo '<div class="container"  >';
                    echo '<div class="row text-center">';
                      echo  '<table class="table">';
                        echo '<tr>
                             <b>Comentarios que realizó en sus compras:</b>
                             </tr>';
                        echo '<tr>';
              ...
              for ($i = 0; $i < $val; $i ++){
                          echo '<tr>';
                            ...
                            echo '<td>' . $array[0][$i]['comentario'] . '</td>';
                          echo '</tr>';
              }
