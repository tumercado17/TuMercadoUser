...
<head>
    <?php
        ...
        require_once("../logica/procesarPregVenta.php");
        sessionCheck();
     ?>
    <meta charset="utf-8">
...
<body>
     ...
     <section  id="services-sec">
        <?php
        if(isset($_SESSION['pregVentas'])){
          if(!empty($_SESSION['pregVentas'])){
              $array = $_SESSION['pregVentas'];
              $val = count($array[0]);
              echo '<section  id="services-sec">';
                 echo '<div class="container"  >';
                    echo '<div class="row text-center">';
                      ...
                      echo '<tr>
                           <b>Comentarios realizados en sus publicaciónes:</b>
                           </tr>';
                        echo '<tr>';
                        ...
                        echo '</tr>';
              for ($i = 0; $i < $val; $i ++){
                      $val1 = count($array[1][$i]);
                      for ($j = 0; $j < $val1; $j ++){
                          echo '<tr>';
                            if($j == 0){
                              echo '<td>' . $array[0][$i]['nombrepubli'] . '</td>';
