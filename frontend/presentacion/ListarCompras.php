...
<head>
    <?php
        ...
        require_once("../logica/procesarListaCompra.php");
        sessionCheck();
     ?>
    <meta charset="utf-8">
...
<body>
     ...
     <section  id="services-sec">
        <?php
        if(isset($_SESSION['compr'])){
          if(!empty($_SESSION['compr'])){
              $array = $_SESSION['compr'];
              $val = count($array[0]);
